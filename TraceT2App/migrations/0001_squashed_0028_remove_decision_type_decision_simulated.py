...
class Migration(migrations.Migration):
    ...
    replaces = [('TraceT2App', '0001_initial'), ('TraceT2App', '0002_alter_mwa_trigger'), ('TraceT2App', '0003_alter_gcnstream_name'), ('TraceT2App', '0004_eventgroup_time'), ('TraceT2App', '0005_containscondition'), ('TraceT2App', '0006_rename_event_notice_and_more'), ('TraceT2App', '0007_rename_events_eventgroup_notices'), ('TraceT2App', '0008_rename_eventgroup_event'), ('TraceT2App', '0009_remove_mwa_minimum_altitude_mwa_exposure_mwa_nobs_and_more'), ('TraceT2App', '0010_mwa_password'), ('TraceT2App', '0011_observation_alter_mwa_frequency'), ('TraceT2App', '0012_trigger_priority'), ('TraceT2App', '0013_remove_trigger_active_trigger_testing'), ('TraceT2App', '0014_remove_trigger_testing_trigger_active_and_more'), ('TraceT2App', '0015_rename_success_observation_status'), ('TraceT2App', '0016_rename_end_observation_finish_and_more'), ('TraceT2App', '0017_alter_observation_status'), ('TraceT2App', '0018_remove_observation_status_observation_istest_and_more'), ('TraceT2App', '0019_observation_event_observation_trigger'), ('TraceT2App', '0020_atca_bandconfig'), ('TraceT2App', '0021_atca_trigger'), ('TraceT2App', '0022_rename_bandconfig_atcaband'), ('TraceT2App', '0023_atca_authentication_token_atca_email_and_more'), ('TraceT2App', '0024_mwa_tileset_alter_atca_maximum_lag_and_more'), ('TraceT2App', '0025_alter_mwa_tileset'), ('TraceT2App', '0026_alter_booleancondition_if_false_and_more'), ('TraceT2App', '0027_alter_decision_event_alter_factor_vote'), ('TraceT2App', '0028_remove_decision_type_decision_simulated')]
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='event',
            index=models.Index(fields=['-created'], name='TraceT2App__created_d60b86_idx'),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('event', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='TraceT2App.event')),
                ('trigger', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='TraceT2App.trigger')),
            ],
        ),
        migrations.CreateModel(
            name='ATCA',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('projectid', models.CharField(max_length=500)),
                ('trigger', models.OneToOneField(default=1, on_delete=django.db.models.deletion.CASCADE, related_name='%(class)s', to='TraceT2App.trigger')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('created', models.DateTimeField(default=django.utils.timezone.now)),
                ('event', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='decisions', to='TraceT2App.event')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('decision', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='factors', to='TraceT2App.decision')),
            ],
        ),
    ]
